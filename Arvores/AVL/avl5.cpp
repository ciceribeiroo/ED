...
NohAVL* NohAVL::RotacionarEsquerda() {
	if(this!=NULL) cout << "umNoh: " << this->mValor << endl;
	else cout << "umNoh: NULL"<< endl;
	NohAVL* aux = this->mPtDir;
	cout << "aux: " << aux->chave << endl;
    this->mPtDir = aux->mPtEsq;
     if(this->dir!= NULL) cout << "umNoh->dir: " << this->dir->chave << endl;
     else cout << "umNoh->dir: NULL" << endl;
    
    if (aux->mPtEsq != NULL){
		cout << "aux->esq != NULL"<< endl;
        aux->mPtEsq->mPtPai = this;
    }
    aux->mPtPai = this->mPtPai;
    cout << "aux->pai: " << aux->mPtPai->mValor << endl;
    aux->mPtEsq = this;
    cout << "aux->esq: " << aux->mPtEsq->mValor << endl;
    this->mPtPai = aux;
    cout << "umNoh->pai: " << this->mPtPai->mValor << endl;
